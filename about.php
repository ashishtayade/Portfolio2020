...
<html lang="en">
  ...
  <div class="js-animsition animsition" data-animsition-in-class="fade-in" data-animsition-out-class="fade-out">
    ...
    <header class="templateux-navbar navbar-light"  data-aos="fade-down">
      <div class="container">
        <div class="row">
          <div class="col-sm-3 col-3"><div class="site-logo"><a href="index.php" class="animsition-link">
          ...
          <div class="col-sm-9 col-9 text-right">
            ...
            <nav class="templateux-menu js-templateux-menu" role="navigation">
              <ul class="list-unstyled">
                <li class="d-md-none d-block"><a href="index.php" class="animsition-link">Home</a></li>
                <li><a href="work.php" class="animsition-link">Work</a></li>
                <li><a href="about.php" class="animsition-link">About</a></li>
                <li><a href="blog.php" class="animsition-link">Freebies</a></li>
                <li><a href="photos.php" class="animsition-link">Photos</a></li>
    ...
    <section class="templateux-hero overlay"  data-scrollax-parent="true">
      <div class="cover" data-scrollax="properties: { translateY: '30%' }"><img src="images/mee3.jpg" /></div>

      <div class="container">
        <div class="row align-items-center justify-content-center intro">
          <div class="col-md-10" data-aos="fade-up">
            <h1>Hello,</h1>
            <p class="lead">I'm Ashish Tayade a Pune based UI developer with<br/> +6 years of experience.</p>
    ...
    <section class="templateux-section" id="next">
      ...
      <div class="container py-5" data-aos="fade-up">
        <div class="row">
          ...
          <div class="col-md-6">
            <p>I am Ashish Tayade, a User interface developer having 6+ years of website development, and design experience.</p>

            <p>I am developing, designing, and realizing creative concepts people can use, which will leave a lasting impression and are simple, clear, and to the point. I believe that the best solution is always a collaborative process between the client, designer, and developer. I think of our clients as partners, their success is ours and we embrace their diversity, whether they are small organizations or multinational corporations.</p>

            <p>I have hands-on experience in HTML5, CSS3, Javascript, and Bootstrap. Experienced in website development, configuration, optimization, migration, custom theme development. Working with various plugins and widgets, customization according to client requirements.</p>

            <p>It has been a great experience so far working with clients around the world. I look forward to working with you and developing optimal and quality solutions for your website/product.</p>

            <p>If you look at my portfolio, you will get to know that clients had a really good experienceworking with me. Just send me a message and we can discuss the project in detail.</p>
          </div>

          <div class="col-md-6">
            <img src="images/mee1.jpg" class="img-fluid">
          </div>
        </div>
